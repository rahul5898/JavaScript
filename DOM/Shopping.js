...
function CreateTable(data){
    ...
    table.setAttribute("style","width : 100%; border: 2px solid black;");
    firstsection.appendChild(table);

    var tr = document.createElement("tr");
    tr.setAttribute("style","height: 40px; border: 1px solid red")
    table.appendChild(tr);

    var col1 = document.createElement("th");
    col1.setAttribute("style","width:50px; border: 1px solid red");
    col1.innerHTML = "S.no"
    tr.appendChild(col1);

    var col2 = document.createElement("th");
    col2.setAttribute("style","width:300px; border: 1px solid red");
    col2.innerHTML = "Name"
    tr.appendChild(col2);
    
    var col3 = document.createElement("th");
    col3.setAttribute("style","width:300px; border: 1px solid red");
    col3.innerHTML = "Brand"
    tr.appendChild(col3);

    var col4 = document.createElement("th");
    col4.setAttribute("style","width:80px; border: 1px solid red");
    col4.innerHTML = "Price"
    tr.appendChild(col4);

    var col5 = document.createElement("th");
    col5.setAttribute("style","width:80px;  border: 1px solid red");
    col5.innerHTML = "Qty."
    tr.appendChild(col5);

    var col6 = document.createElement("th");
    col6.setAttribute("style","width:100px; border: 1px solid red");
    ...
    tablerow.setAttribute("style","height: 35px; border: 1px solid red");

    var col1 = document.createElement("td");
    col1.setAttribute("style","text-align:center; border: 1px solid red");
    col1.innerHTML = product.id;
    tablerow.appendChild(col1);

    var col2 = document.createElement("td");
    col2.setAttribute("style","border: 1px solid red");
    col2.innerHTML = product.title
    tablerow.appendChild(col2);
    
    var col3 = document.createElement("td");
    col3.setAttribute("style","border: 1px solid red");
    col3.innerHTML = product.brand
    tablerow.appendChild(col3);

    var col4 = document.createElement("td");
    col4.setAttribute("style","border: 1px solid red");
    col4.innerHTML = product.price
    var price = product.price;
    tablerow.appendChild(col4);

    var col5 = document.createElement("td");
    col5.setAttribute("style","text-align:center; border: 1px solid red");
    ...
    input.setAttribute("style"," width: 50px; height: 20px");
    // col5.innerHTML = "1"
    col5.appendChild(input);
    tablerow.appendChild(col5);
    
    // var qty = document.getElementById("inputnumber");
    // var qty = document.querySelector("input").value;
    ...
    col6.setAttribute("style","text-align:right; border: 1px solid red");
    col6.innerHTML = "0";
